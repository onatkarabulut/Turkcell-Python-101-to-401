...
t = ("tuple",)
    #eğer tuple içerisine tek veri gireceksen 
    #pythonın onu tuple olarak algılaması için virgül 
    #kullanman gereki
...
s.discard("ali")
#aynı elemanı iki kez silmeye çalıştığımızda hata alırız
#ya da olmayan bir elemanı silmeye çalıştığımızda
#bu fonksiyon bunu önlemektedir
